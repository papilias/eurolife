...
namespace Wedia.Foundation.SitecoreExtensions.Sitemap
{
    ...
    public override void Process(HttpRequestArgs args)
    {
          ...
          !System.IO.Directory.Exists(args.HttpContext.Request.PhysicalPath))
      {
        ...
        try
        {
          ...
          // Get all decendants of Homepage to create full Sitemap - exclude local items.
          var childrens = homepage.Axes.GetDescendants().Where(x => !x.Paths.Path.Contains("_Local"));
