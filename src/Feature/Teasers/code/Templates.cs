    ...
    public struct Templates
    {
        ...
        public struct TeaserContent
        {
            ...
            public struct Fields
            {
                ...
                public static readonly ID TeaserLink = new ID("{F749E224-0A8C-4448-9B12-F4451CAA7E09}");
                public static readonly ID TeaserLabel = new ID("{12F214C9-16EE-4CF1-9220-7D1C8FEFC9A1}");
            }
        }
    }
}